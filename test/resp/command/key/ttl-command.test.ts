...
describe(
    ...
    () => {
         ...
         */
        it(
            "should report -2 when the key does not exist",
            async() => {
        ...
        it(
            "should return -1 when the key exists but does not have a ttl",
            async() => {
                response = await sendCommand(
                    client,
                    [
        ...
        it(
            "should return the current ttl in seconds when available",
            async() => {
                response = await sendCommand(
                    client,
                    [
