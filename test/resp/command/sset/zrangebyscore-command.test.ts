...
describe(
    ...
    () => {
        ...
        it(
            "should supply +Infinity for +inf as min parameter",
            async() => {
                response = await sendCommand(
                    client,
                    [
        ...
        it(
            "should supply -Infinity for -inf as max parameter",
            async() => {
                response = await sendCommand(
                    client,
                    [
        ...
        it(
            "should recognize invalid min parameter",
            async() => {
        ...
        it(
            "should recognize invalid max parameter",
            async() => {
                // NOTE: 'inf' is NOT invalid to redis
                response = await sendCommand(
                    client,
        ...
        it(
            "should recognize the WITHSCORES option",
            async() => {
                response = await sendCommand(
                    client,
                    [
        ...
        it(
            "should error when an invalid limit option is specified",
            async() => {
                response = await sendCommand(
                    client,
                    [
