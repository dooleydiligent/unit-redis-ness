...
describe(
    ...
    () => {
         ...
         */
        it(
            "should report the INCREMENT when incrby called against non-existing key",
            async() => {
        ...
        it(
            "should have created the key from the previous test",
            async() => {
        ...
        // DECRBY command
        it(
            "should report the NEGATIVE increment when decrby called against unknown key",
            async() => {
        ...
        it(
            "should support negative increment and positive decrement",
            async() => {
                let response: any = await sendCommand(
                    client,
                    [
        ...
        it(
            "should fail to increment a HASH value",
            async() => {
