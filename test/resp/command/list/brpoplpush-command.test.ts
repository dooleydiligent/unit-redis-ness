...
describe(
    ...
    () => {
         ...
         */
        it(
            "should return NIL when destination does not exist and timeout expires",
            async() => {
        ...
        it(
            "should return the poplpushed value when lpush is called",
            (done) => {
                sendCommand(
                    client,
                    [
        ...
        it(
            "should wait indefinitely (28 days) for a value to be available",
            (done) => {
