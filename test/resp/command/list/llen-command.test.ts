...
describe(
    ...
    () => {
         ...
         */
        it(
            "should report 0 when llen called on non-existent key",
            async() => {
        ...
        it(
            "should report WRONGTYPE when attempting to get llen of non-list key",
            async() => {
                response = await sendCommand(
                    client,
                    [
        ...
        it(
            "should return the correct list length",
            async() => {
