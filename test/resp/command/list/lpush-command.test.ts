...
describe(
    ...
    () => {
         ...
         */
        it(
            "should report ERR when attempting to lpush to a non-list key",
            async() => {
        ...
        it(
            "should create a list if it doesn't already exist",
            async() => {
                response = await sendCommand(
                    client,
                    [
        ...
        it(
            "should have created the list in a predicatble order",
            async() => {
                response = await sendCommand(
                    client,
                    [
