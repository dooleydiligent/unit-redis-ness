...
describe(
    ...
    () => {
        ...
        it(
            "should add, get, and delete an entry",
            async() => {
                z = new Z();
                ss = new SortedSet();
                let added = z.add(
        ...
        it(
            "should throw when attempting to add __proto__ key",
            async() => {
                z = new Z();
                ss = new SortedSet();
                expect(() => {
        ...
        it(
            "should not add an undefined or null score",
            async() => {
                z = new Z();
                ss = new SortedSet();
                let added = z.add(
        ...
        it(
            "should not duplicate key/value pairs",
            async() => {
                z = new Z();
                ss = new SortedSet();
                let added = z.add(
        ...
        it(
            "should return the old rank when replacing a key",
            async() => {
                z = new Z();
                ss = new SortedSet();
                let added = z.add(
         ...
         */
        xit(
            "should return a value when adding at least 32 values (I think - it is difficult to tell)",
            async() => {
                z = new Z();
                ss = new SortedSet();
                let returnValue;
        ...
        it(
            "should do what the documentation says here: https://www.npmjs.com/package/redis-sorted-set",
            async() => {
                z = new Z();
                ss = new SortedSet();
                expect(z.add(
                ...
                expect(z.rangeByScore(8)).to.eql([
                    "District 9",
                    "Terminator",
                    "The Matrix"
                ]); // [8.0-∞)
        ...
        it(
            "the rewrite should do what the documentation says here: https://www.npmjs.com/package/redis-sorted-set",
            async() => {
                z = new Z();
                ss = new SortedSet();
                expect(ss.add(
                ...
                // => ['Ex Machina', 'District 9', 'Terminator']
                expect(ss.rangeByScore(8)).to.eql([
                    "District 9",
                    "Terminator",
                    "The Matrix"
                ]); // [8.0-∞)
            ...
            () => {
                it(
                    ...
                    () => {
                        ...
                        expect(z.toArray()).to.eql(z.range(
                            0,
                            -1
                        ));
                ...
                describe(
                    ...
                    () => {
                        it(
                            "should delete special elements",
                            () => {
                                const z = new Z();
                ...
                describe(
                    ...
                    () => {
                        it(
                            "should strip out a range of elements",
                            () => {
                                const z = new Z();
                        ...
                        it(
                            "should strip out all the elements",
                            () => {
                                const z = new Z();
                ...
                describe(
                    ...
                    () => {
                        it(
                            "should strip out a slice of elements",
                            () => {
                                const z = new Z();
                ...
                describe(
                    ...
                    () => {
                        it(
                            "should ensure values are unique",
                            () => {
                                const z = new Z({"unique": true});
                                assert.equal(
                                    z.keys().length,
                                    0,
                                    "Expected an empty SortedSet"
                                );
                                ...
                                expect(() => {
                                    z.add(
                                        "5a600dff",
                                        z._head.next[z._level - 1].next.value
                                    );
                                }).to.throw(/unique/);
                        ...
                        it(
                            "should revert keys if constraint broken during update",
                            () => {
                                const z = new Z({"unique": true});
                ...
                describe(
                    ...
                    () => {
                        it(
                            ...
                            () => {
                                ...
                                expect(() => {
                                    ss.add(
                                        "5a600dff",
                                        ss._head.next[ss._level - 1].next.value
                                    );
                                }).to.throw(/unique/);
                        ...
                        it(
                            "should revert keys if constraint broken during update",
                            () => {
                                const ss = new SortedSet({"unique": true});
                                ss.add(
                                    "5a600e10",
                                    16
                                );
